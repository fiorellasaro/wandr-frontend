...
- `src/entities`: domain types for onboarding, itinerary and wandrs
...
4. Wire the same service boundary into the Android build generated by Capacitor.

## Android mobile setup

Capacitor is configured with:

- app id: `com.wandr.app`
- app name: `Wandr`
- web output: `dist`
...
`cap:sync:android` builds the Vite bundle and copies it into the native Android project. Run it after frontend changes before opening or running the Android app from Android Studio.
